...
var FacebookPhotoProvider = (function (_PhotoProvider) {
  ...
  function FacebookPhotoProvider() {
    ...
    _get(Object.getPrototypeOf(FacebookPhotoProvider.prototype), 'constructor', this).call(this, '/me/photos/uploaded', '/me/albums');
    this.name = 'facebook';
  ...
  _createClass(FacebookPhotoProvider, [{
    ...
    value: function buildAlbum(data) {
      return new _Album2['default'](data.id, data.name, this.apiGetAlbumPhotosURL(data.id), data.cover_photo);
    }
  }]);
...
},{"./Album":99,"./Photo":104,"./PhotoProvider":106,"./facebook-sdk":107,"jquery":96}],102:[function(require,module,exports){
'use strict';
  ...
  _createClass(PhotoPicker, [{
    ...
    value: function renderAlbums(albums) {
      ...
      if (!this.albumsRendered) {
        ...
        var albumPromises = (0, _util.objectToArray)(albums, function (album) {
          if (album.cover_photo) {
            return _this3.photoProvider.apiGetPhoto(album.cover_photo).then(function (photo) {
              album.photo = photo;
              return album;
            });
          }
        ...
        return Promise.all(albumPromises).then(function (a) {

          a.forEach(function (album) {
            _this3.albumsPanel.append(album.getHTML());
          });

          _this3.albumsRendered = true;
        });
      }
    ...
    value: function loadMore() {
      ...
      this.loadPhotos()['catch'](_util.warn).then(function () {
...
},{"./Album":99,"./Photo":104}],107:[function(require,module,exports){
'use strict';
...
exports.info = info;
var warn = window.console.warn.bind(window.console);
