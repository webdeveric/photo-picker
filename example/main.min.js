...
(0, _jquery2['default'])(function () {
  ...
  (0, _jquery2['default'])(document.documentElement).on('selected.photopicker', function (e, url) {
    if (url) {
      var img = new Image();
...
},{"../src/FacebookPhotoProvider":101,"../src/InstagramPhotoProvider":102,"../src/Lightbox":103,"../src/PhotoPicker":105,"babelify/polyfill":94,"jquery":96}],2:[function(require,module,exports){
(function (global){
"use strict";
        ...
        (0, _facebookSdk2['default'])(_this3.sdkSettings).then(function (FB) {
          ...
          FB.api(url, parameters, function (response) {
            ...
            if (response && !response.error) {
              ...
              _util.debug.log(response);
              resolve(response);
            } else {

              var err = new Error(response.error.message ? response.error.message : 'FB.api failed');

              _util.debug.error(err);
              reject(err);
            }
          });
        },
  ...
  _createClass(PhotoPicker, [{
    ...
    value: function open() {
      ...
      this.init().then(function (initResults) {
        ...
        _this2.trigger('error.photopicker', [_this2, err]);
      });
    ...
    value: function loadPhotos() {
      ...
      return this.photoProvider.loadPhotos().then(_jquery2['default'].proxy(this.renderPhotos, this)).then(_jquery2['default'].proxy(this.toggleLoadMoreDisabled, this)).then(removeLoadingClass, removeLoadingClass);
    }
  }, {
    ...
    value: function loadMore() {
      ...
      this.loadPhotos()['catch'](_util.debug.warn).then(function () {
        _this5.toggleLoadMoreDisabled(false);
      });
    }
  }, {
    key: 'clearSelected',
