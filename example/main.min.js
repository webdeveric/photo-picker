...
},{"../src/FacebookPhotoProvider":192,"../src/InstagramPhotoProvider":193,"../src/Lightbox":194,"../src/PhotoPicker":196,"../src/util":199,"babelify/polyfill":184,"jquery":186}],2:[function(require,module,exports){
(function (global){
"use strict";
...
},{"./ContentProvider":190,"jquery":186}],189:[function(require,module,exports){
'use strict';
...
},{"./Photo":195}],190:[function(require,module,exports){
'use strict';
...
var ContentProvider = (function (_EventDispatcher) {
  _inherits(ContentProvider, _EventDispatcher);
  ...
  function ContentProvider() {
    ...
    _get(Object.getPrototypeOf(ContentProvider.prototype), 'constructor', this).call(this);
...
},{"./EventDispatcher":191}],191:[function(require,module,exports){
'use strict';
...
var EventDispatcher = (function () {
  ...
  _createClass(EventDispatcher, [{
    ...
    key: 'offEvent',
    value: function offEvent(eventName, handler) {
      if (this.listeners[eventName]) {
        if (handler === null) {
    ...
    value: function on(events, handler) {
      ...
      this.parseEvents(events).forEach(function (eventName) {
        _this.onEvent(eventName, handler);
      });
    ...
    value: function off(eventName) {
      ...
      this.parseEvents(events).forEach(function (eventName) {
        _this2.offEvent(eventName, handler);
      });
    ...
    value: function trigger(eventName) {
      ...
      if (this.listeners[eventName]) {
        (function () {
          ...
          var queue = _this3.listeners[eventName];
...
var FacebookPhotoProvider = (function (_PhotoProvider) {
  ...
  function FacebookPhotoProvider() {
    ...
    var scopes = arguments.length <= 1 || arguments[1] === undefined ? ['public_profile', 'user_photos'] : arguments[1];
...
},{"./Album":189,"./Photo":195,"./PhotoProvider":197,"./facebook-sdk":198,"./util":199,"jquery":186}],193:[function(require,module,exports){
'use strict';
...
},{"./Photo":195,"./PhotoProvider":197,"jquery":186,"popup-window":187}],194:[function(require,module,exports){
'use strict';
...
var Lightbox = (function (_EventDispatcher) {
  _inherits(Lightbox, _EventDispatcher);
...
},{"./AjaxContentProvider":188,"./ContentProvider":190,"./EventDispatcher":191,"jquery":186}],195:[function(require,module,exports){
'use strict';
...
var PhotoPicker = (function (_ContentProvider) {
  ...
  _createClass(PhotoPicker, [{
    ...
    key: 'bindEvents',
    value: function bindEvents() {
      (0, _jquery2['default'])(document.documentElement).on('keyup.photopicker', this.handleKeyup.bind(this));
    ...
    value: function open() {
      ...
      this.init().then(function (initResults) {
        ...
        _this2.trigger('error.photopicker', { error: error });
      });
    ...
    value: function handleSubmit(e) {
      ...
      if (photo !== false) {
        this.trigger('selected.photopicker', { photo: photo, photoProvider: this.photoProvider });
        this.close();
      }
    }
  }, {
...
},{"./ContentProvider":190,"./Lightbox":194,"./PhotoProvider":197,"./util":199,"jquery":186}],197:[function(require,module,exports){
'use strict';
...
},{"./Album":189,"./Photo":195,"./util":199}],198:[function(require,module,exports){
'use strict';
...
},{"jquery":186}],199:[function(require,module,exports){
'use strict';
